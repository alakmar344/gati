        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center flex flex-col items-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full glass-panel shadow-sm border border-white/80 mb-6 animate-in fade-in slide-in-from-bottom-3 duration-500">
            <div className="flex -space-x-1.5 overflow-hidden">
              <div className="w-5 h-5 rounded-full bg-emerald-600 text-white flex items-center justify-center font-bold text-[9px] border border-white">VS</div>
              <div className="w-5 h-5 rounded-full bg-sky-600 text-white flex items-center justify-center font-bold text-[9px] border border-white">PS</div>
              <div className="w-5 h-5 rounded-full bg-amber-600 text-white flex items-center justify-center font-bold text-[9px] border border-white">AS</div>
            </div>
            <span className="text-xs font-semibold text-slate-800">
              Modern Indian Vehicle & Driving Services Reimagined
            </span>
          </div>
          ...
          <h1 className="text-4xl sm:text-6xl md:text-7xl font-extrabold tracking-tight text-slate-900 leading-[1.08] max-w-4xl mb-6">
            Your vehicle services. <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-700 via-teal-700 to-sky-700">
              Finally simple.
            </span>
          </h1>
          ...
          <p className="text-base sm:text-lg md:text-xl text-slate-700 max-w-2xl mx-auto leading-relaxed mb-8 font-normal">
            Licences, registrations, VIP plates, FASTag telemetry, and 10-second instant mobility passes—all in one serene platform.
          </p>
          ...
          <div className="flex flex-wrap items-center justify-center gap-2.5 text-xs font-bold text-slate-700">
            ...
            <Link href="/fastpass" className="px-3.5 py-1.5 rounded-full bg-amber-500 text-slate-950 shadow-2xs hover:bg-amber-400 flex items-center gap-1.5 font-black">
            ...
            <Link href="/fastag" className="px-3.5 py-1.5 rounded-full bg-white/90 border border-slate-200 shadow-2xs hover:bg-white flex items-center gap-1.5 text-sky-800">
              ...
              <span>FASTag Radar</span>
            </Link>
            <Link href="/adtt-simulator" className="px-3.5 py-1.5 rounded-full bg-white/90 border border-slate-200 shadow-2xs hover:bg-white flex items-center gap-1.5 text-purple-800">
