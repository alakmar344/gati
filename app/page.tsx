  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="px-3 sm:px-6 pt-2">
        <div className="relative max-w-6xl mx-auto rounded-[2.25rem] overflow-hidden bg-slate-950 text-white shadow-2xl">
          {/* ambient glow */}
          <div className="absolute -top-32 -left-16 w-96 h-96 rounded-full bg-emerald-500/25 blur-3xl" aria-hidden />
          <div className="absolute -bottom-40 right-0 w-[28rem] h-[28rem] rounded-full bg-sky-500/15 blur-3xl" aria-hidden />
          <div
          ...
          <div className="relative px-5 sm:px-12 py-12 sm:py-16 text-center flex flex-col items-center">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/10 border border-white/15 mb-6 animate-rise">
              <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse" />
              <span className="text-xs font-bold tracking-wide text-slate-200">Gati Autopilot · भारत Mobility OS</span>
            </div>
            ...
            >
              <span className="absolute -inset-0.5 rounded-2xl bg-gradient-to-r from-emerald-500/60 via-sky-500/40 to-emerald-500/60 blur opacity-50 group-hover:opacity-90 transition-opacity" aria-hidden />
              <span className="relative flex items-center gap-3 rounded-2xl bg-white/[0.07] border border-white/15 px-4 py-4 text-left backdrop-blur">
                <Wand2 className="w-5 h-5 text-emerald-400 shrink-0" />
                <span className="flex-1 min-w-0">
                  <span className="block text-[15px] text-slate-300 truncate">
                    Ask Gati to <span className="text-white font-semibold">“{EXAMPLES[ph]}”</span>
                  </span>
                </span>
                <kbd className="hidden sm:inline-flex items-center gap-0.5 text-[11px] font-bold text-slate-300 bg-white/10 border border-white/15 rounded-md px-1.5 py-1 shrink-0">
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 mt-5 animate-rise" style={{ animationDelay: '0.14s' }}>
              {EXAMPLES.map((ex) => (
                <button
                  ...
                  className="px-3 py-1.5 rounded-full bg-white/[0.06] hover:bg-white/[0.12] border border-white/10 text-xs font-medium text-slate-300 hover:text-white transition-colors"
                >
                  {ex}
                </button>
              ))}
      ...
      <section className="px-4 sm:px-8 max-w-6xl mx-auto w-full pt-14 pb-8">
        <div className="flex items-center justify-between mb-5">
          ...
          <button onClick={() => openCopilot()} className="text-xs font-bold text-emerald-700 hover:text-emerald-800 inline-flex items-center gap-1">
