    ...
    <div className="min-h-screen py-10 px-4 sm:px-8 max-w-5xl mx-auto space-y-8">
      ...
      <div className="text-center max-w-xl mx-auto">
        <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-100 text-emerald-800 text-xs font-bold uppercase tracking-wider mb-2">
          ...
          <span>Sub-Second OCR & Diagnostic Engine</span>
        </div>
        <h1 className="text-3xl sm:text-4xl font-extrabold text-slate-900 tracking-tight">
          Gati Smart Lens
        </h1>
        <p className="text-xs sm:text-sm text-slate-600 mt-1">
          Scan any physical Indian Registration Card, Driving Licence, or HSRP Number Plate to extract fields with 100% precision.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-6 glass-panel p-6 sm:p-8 rounded-3xl border border-white/80 shadow-xl flex flex-col justify-between space-y-6">
          <div>
            ...
            {/* Viewfinder Screen */}
            <div className="aspect-[4/3] rounded-2xl bg-slate-950 border-2 border-slate-700 relative overflow-hidden flex flex-col items-center justify-center p-6 text-white shadow-2xl">
              ...
              <div className="text-center z-10 space-y-3">
                {selectedSample === 'rc-nexon' && (
                  <div className="p-3 rounded-xl bg-white/10 backdrop-blur-md border border-white/20 text-xs">
                    ...
                    <div className="font-mono text-[11px] text-slate-200">KA 01 EK 4920 • TATA NEXON EV</div>
                  </div>
                )}
                ...
                {selectedSample === 'dl-ananya' && (
                  <div className="p-3 rounded-xl bg-white/10 backdrop-blur-md border border-white/20 text-xs">
                    ...
                    <div className="font-mono text-[11px] text-slate-200">MH 12 2026 0094821 • ANANYA D</div>
                  </div>
                )}
        ...
        <div className="lg:col-span-6 glass-panel p-6 sm:p-8 rounded-3xl border border-white/80 shadow-xl flex flex-col justify-between space-y-6">
          {activeResult ? (
            <div className="space-y-5 animate-in fade-in duration-300">
              ...
              <div className="bg-slate-50 p-4 rounded-2xl border border-slate-200 space-y-2 text-xs divide-y divide-slate-200/60">
                ...
                <div className="space-y-1.5">
                  {activeResult.healthFlags.map((flag, idx) => (
                    ...
                    >
                      ...
                      <span className="text-[11px] text-slate-600">{flag.desc}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <Link
                ...
                className="w-full py-3 rounded-full bg-slate-900 hover:bg-slate-800 text-white font-bold text-xs flex items-center justify-center gap-2 shadow-md transition-all hover:scale-[1.01]"
              >
            ...
            <div className="py-16 text-center space-y-4 my-auto">
              ...
              <button
                onClick={() => handleTriggerScan('rc-nexon')}
                className="px-6 py-2.5 rounded-full bg-emerald-600 text-white font-bold text-xs shadow-sm hover:bg-emerald-700 transition-all inline-flex items-center gap-2"
              >
