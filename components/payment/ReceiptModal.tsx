      ...
      >
        ...
        <div className="p-6 space-y-4">
          <div className="text-center py-3 bg-emerald-50 dark:bg-emerald-900/30 rounded-2xl border border-emerald-100 dark:border-emerald-800/60">
            <span className="text-xs text-emerald-800 dark:text-emerald-300 font-medium">Total Paid (Simulated)</span>
          ...
          <div className="space-y-2.5 text-xs text-slate-600 dark:text-slate-300">
            ...
            <div className="flex justify-between border-b border-slate-100 dark:border-slate-800 pb-1.5">
              <span className="text-slate-400 dark:text-slate-500">Application Ref</span>
              <span className="font-mono font-bold text-sky-700 dark:text-sky-400">{receipt.applicationNumber}</span>
            </div>
            <div className="flex justify-between border-b border-slate-100 dark:border-slate-800 pb-1.5">
              <span className="text-slate-400 dark:text-slate-500">Bank UTR</span>
              <span className="font-mono text-slate-800 dark:text-slate-200">{receipt.utrNumber}</span>
            </div>
            <div className="flex justify-between border-b border-slate-100 dark:border-slate-800 pb-1.5">
              <span className="text-slate-400 dark:text-slate-500">Payment Mode</span>
            ...
            <div className="flex justify-between border-b border-slate-100 dark:border-slate-800 pb-1.5">
              <span className="text-slate-400 dark:text-slate-500">Payer</span>
